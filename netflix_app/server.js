...
const apiKey = "350b41b6c5845eb59987005395db4b6d";
const databaseUrl = `postgres://ahmad:0000@localhost:5432/ahmad`;
...
function addMovieHandler(req, res) {
  ...
  let sql =
    "INSERT INTO movie(name,time,summary,image,comment) VALUES($1, $2, $3, $4, $5) RETURNING *;";
